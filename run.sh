...
python -m prepocess.build_valid --processes=10 --fsamples=dev_behaviors.tsv --root=adressa --dataset=adressa --type=test
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python validate.py --gpus=4 --epoch=10 --filenum=2 --root=adressa --start_dev=0

CUDA_VISIBLE_DEVICES=4,5,6,7 python deers_train.py --gpus=4 --epoch=10 --filenum=1 --root=adressa --port=9440
CUDA_VISIBLE_DEVICES=4,5,6,7 python deers_validate.py --gpus=4 --epoch=4 --filenum=2 --root=adressa --start_dev=0
